...
async def lifespan(app: FastAPI):
    ...
    from app.services.ml_data_logger import MLDataPoint  # noqa
    ...
    # Start server-side trade simulator
    ...
    logger.info("Server-side simulator started (checking prices every 30s)")
