...
class DiagnosticsService:
    ...
    async def _check_price_providers(self) -> List[str]:
        """Check price provider health from JIT simulator stats."""
        issues = []
        try:
    ...
    async def _send_health_summary(self):
        ...
        try:
            ...
            text = (
                ...
                f"━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                f"📡 Price Providers   {active_providers}/2 active\n"
