...
# Finnhub: forex via OANDA feed, crypto via Binance, stocks as-is
FH_MAP = {
    # Forex via OANDA
    ...
    # Gold/Silver — Finnhub doesn't have OANDA commodity feeds
    # These will rely solely on TwelveData
    # Crypto via Binance
    "BTCUSD": "BINANCE:BTCUSDT", "ETHUSD": "BINANCE:ETHUSDT",
    "SOLUSD": "BINANCE:SOLUSDT", "XRPUSD": "BINANCE:XRPUSDT",
    "LINKUSD": "BINANCE:LINKUSDT",
    # US Equities (Finnhub free tier covers US stocks)
    "TSLA": "TSLA", "AAPL": "AAPL", "MSFT": "MSFT",
    "NVDA": "NVDA", "AMZN": "AMZN", "META": "META",
    "GOOGL": "GOOGL", "NFLX": "NFLX", "AMD": "AMD",
    # Indices — Finnhub uses ^prefix for some
    "US30": "^DJI", "US100": "^IXIC", "NAS100": "^NDX",
}
