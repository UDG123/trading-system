...
1. Consensus score is your primary guide (7+ = HIGH confidence, 4-6 = MEDIUM, 2-3 = LOW, <2 = SKIP)
...
RULES:
- If consensus score < 2: ALWAYS SKIP
...
class ClaudeCTO:
    ...
    def _check_hard_rules(
        ...
        # Consensus below minimum
        if consensus.get("total_score", 0) < 2:
            reasons.append(
                f"Consensus score {consensus.get('total_score', 0)} below minimum threshold of 2"
            )
